var plates;
var myMap;
var plateLocations = "./static/data/Plates.json";

d3.json(plateLocations,function(response){
...
function displayLegend(){
    ...
    for (i = 0; i < legendInfo.length; i++){
        legendString += "<p style = \"background-color: "+legendInfo[i].color+"\">"+legendInfo[i].limit+"</p> ";
    }
    
    return header+legendString;
